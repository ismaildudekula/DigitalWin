...
export const Services: React.FC = () => {
  return (
    <section id="services" className="py-24 bg-dark-900 relative overflow-hidden">
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-primary-600/10 rounded-full blur-3xl"></div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <h2 className="text-primary-500 font-semibold uppercase tracking-wider mb-2">To Grow Your Business Today</h2>
          <h3 className="text-4xl md:text-5xl font-bold text-white">You Need Digital Marketing</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="group relative bg-dark-950 rounded-3xl p-8 border border-gray-800 hover:border-primary-500/30 transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-b from-primary-500/5 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-primary-900/50 rounded-2xl flex items-center justify-center mb-6">
                        <Smartphone className="text-primary-400 w-8 h-8" />
                    </div>
                    ...
                    <a href="#contact" className="text-primary-400 font-medium hover:text-primary-300 flex items-center gap-2 group-hover:gap-3 transition-all">
            ...
            {/* Card 3 - Changed to Orange to distinguish from Primary Red */}
            <div className="group relative bg-dark-950 rounded-3xl p-8 border border-gray-800 hover:border-orange-500/30 transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-b from-orange-500/5 to-transparent rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative z-10">
                    <div className="w-14 h-14 bg-orange-900/50 rounded-2xl flex items-center justify-center mb-6">
                    ...
                    <a href="#contact" className="text-orange-400 font-medium hover:text-orange-300 flex items-center gap-2 group-hover:gap-3 transition-all">
                        Know more <span aria-hidden="true">&rarr;</span>
                    </a>
                </div>
            </div>
